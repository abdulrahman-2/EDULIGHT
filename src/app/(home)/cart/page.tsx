...
<CustomHeading title='Shopping Cart'/>
      <div className="flex flex-col gap-6 pt-10">
        <div className="container mx-auto max-w-7xl ">
          <h1 className="text-2xl font-semibold">
            Shopping Cart <span className="font-normal">({courses.length})</span>
          </h1>
            ...
            {courses.map((course) => (
              ...
              >
                <div className=" flex items-center ">
                  ...
                  <IoCloseCircleOutline className='text-4xl' />                    <div className="relative w-[260px]  h-[120px]">
                      <Image
                        src={course.image}
                        alt={course.title}
                        fill
  ...
  <div className="col-span-4 lg:col-span-1 border rounded-lg p-6  h-fit lg:sticky lg:top-5">
    ...
    <div className="flex justify-between mb-2  text-lg">
     ...
     <div>
      <input type="text" placeholder='Coupon Code' className='border rounded-lg px-4 py-2 w-full relative' />
      <button className='bg-black hover:bg-black/80 duration-200 text-white py-2 px-4 rounded-lg absolute right-5' >Apply</button>
     </div>
  </div>
